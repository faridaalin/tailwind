    ...
    <header className="bg-gray-100">
      <div className="sm:flex sm:items-center sm:justify-between sm:px-6 sm:py-4">
        ...
        <div className={`${isOpen ? "block" : "hidden"} absolute w-full px-3 pb-4 sm:static sm:w-auto sm:flex sm:p-0 `}>
          <a href="/" className="block px-3 py-1 mb-1 text-black hover:bg-gray-300 rounded sm:mb-0 sm:ml-2">Register</a>
          <a href="/" className="block px-3 py-1 text-black hover:bg-gray-300 rounded sm:ml-2">Login</a>
        </div>
      </div>
    </header>
  );
